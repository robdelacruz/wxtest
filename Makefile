...
WX_LIBS=-L/usr/local/lib -pthread   /usr/local/lib/libwx_gtk3u-3.3.a -lwxscintilla-3.3 -lwxlexilla-3.3 -lgtk-3 -lgdk-3 -lz -lpangocairo-1.0 -lpango-1.0 -lharfbuzz -latk-1.0 -lcairo-gobject -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lgobject-2.0 -lglib-2.0 -lX11 -lgthread-2.0 -pthread -lglib-2.0 -lSM -lxkbcommon -lgtk-3 -lgdk-3 -lz -lpangocairo-1.0 -lpango-1.0 -lharfbuzz -latk-1.0 -lcairo-gobject -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lgobject-2.0 -lglib-2.0 -lXtst -lpangoft2-1.0 -lpango-1.0 -lgobject-2.0 -lglib-2.0 -lharfbuzz -lfontconfig -lfreetype -lpng -lz -ljpeg -ltiff -ljbig -lexpat -lz -lexpat -lpcre2-32 -lpng -lz -ljpeg -ltiff -ljbig -lz -lcurl -lm 
